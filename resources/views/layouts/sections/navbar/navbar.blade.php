          ...
          <li class="nav-item navbar-dropdown dropdown-user dropdown">
            <a class="nav-link dropdown-toggle hide-arrow p-0" href="javascript:void(0);" data-bs-toggle="dropdown">
              <div class="avatar avatar-online">
                <img src="{{ asset('assets/img/logo-getpromo.svg') }}" alt class="rounded-circle">
              </div>
            </a>
            <ul class="dropdown-menu dropdown-menu-end">
              ...
              <li>
                <a class="dropdown-item" href="javascript:void(0);">
                  <i class="ti ti-user me-3 ti-md"></i><span class="align-middle">Mój Profil</span>
                </a>
              </li>
              <li>
                <a class="dropdown-item" href="{{ route('leads.index') }}">
                  <i class="ti ti-users me-3 ti-md"></i><span class="align-middle">Leady</span>
                </a>
              </li>
              <li>
                <div class="dropdown-divider my-1 mx-n2"></div>
                ...
                <li>
                  <div class="d-grid px-2 pt-2 pb-1">
                    <a class="btn btn-sm btn-danger d-flex" href="{{ route('logout') }}" onclick="event.preventDefault(); document.getElementById('logout-form').submit();">
                      <small class="align-middle">Wyloguj</small>
                ...
                <li>
                  <div class="d-grid px-2 pt-2 pb-1">
                    <a class="btn btn-sm btn-primary d-flex" href="{{ Route::has('login') ? route('login') : url('auth/login-basic') }}">
                      <small class="align-middle">Zaloguj się</small>
