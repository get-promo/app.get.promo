...
Route::get('/sprawdz-wizytowke/debug', [LandingController::class, 'debugPage'])->name('landing.debug');
...
Route::any('/api/public/debug-request', [LandingController::class, 'debugRequest'])->name('landing.debug-request');
